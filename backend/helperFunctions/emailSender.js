...
function sendEmailVerification(username, email, emailVerificationToken) {
    ...
    <p>
      ...
      please confirm your email address.
		...
		<a href=${CLIENT_URL}/verify/${username}/${emailVerificationToken}>
    <button 
      type="button"
    ...
    <a href=${CLIENT_URL}/verify/${username}/${emailVerificationToken}>http://localhost:${process.env.CLIENT_PORT}/verify/${username}/${emailVerificationToken}</a> <br />
